...
void Draw8Points(HDC hdc, int xc, int yc, int a, int b, COLORREF color)
{
	...
	DrawLine1(hdc,xc,yc, xc + a, yc + b, RGB(90,10,10)); //1
	
	SetPixel(hdc, xc + b, yc + a, color);                 
	DrawLine1(hdc,xc,yc, xc + b, yc + a, RGB(90,10,10));//2
	
	SetPixel(hdc, xc - b, yc + a, color);                 
	DrawLine1(hdc,xc,yc, xc - b, yc + a, RGB(0,5,70));//3
	
	SetPixel(hdc, xc - a, yc + b, color);
	DrawLine1(hdc,xc,yc, xc - a, yc + b, RGB(0,55,0));//4
	...
	SetPixel(hdc, xc + b, yc - a, color);
	DrawLine1(hdc,xc,yc, xc + b, yc - a, RGB(0,55,0));//7
	
	SetPixel(hdc, xc + a, yc - b, color);                 
	DrawLine1(hdc,xc,yc, xc + a, yc - b, RGB(0,5,70));//8
}
